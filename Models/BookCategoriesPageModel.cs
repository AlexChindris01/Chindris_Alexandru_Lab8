...
namespace Chindris_Alexandru_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Chindris_Alexandru_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Chindris_Alexandru_Lab8Context context,
